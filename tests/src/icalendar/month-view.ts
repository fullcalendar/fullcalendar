...
import { default as multidayEvent } from './data/multidayEvent.js'
import { default as multipleMultidayEvents } from './data/multipleMultidayEvents.js'
import { default as multipleEventsOneMunged } from './data/multipleEventsOneMunged.js'
