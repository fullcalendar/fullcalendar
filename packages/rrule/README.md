...
```sh
npm install @teamdiverst/fullcalendar-core @teamdiverst/fullcalendar-rrule @teamdiverst/fullcalendar-daygrid
```
...
import rrulePlugin from '@teamdiverst/fullcalendar-rrule'
