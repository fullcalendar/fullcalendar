function ResourceView(element, calendar, viewName) {
  ...
  t.dragStop = dragStop;
  t.getResources = calendar.fetchResources(); // this is the key
  // imports
  ...
  function buildDayTableHeadHTML() {
    ...
    // loop for the resources to set the headers
    for (i = 0; i < resources.length; i++) {
      //date = cellToDate(0, i);
      html +=
      //"<th class='fc-" + dayIDs[date.getDay()] + " fc-col" + i + ' ' + headerClass + "'>" +
      "<th class='fc-col" + i + ' ' + headerClass + "'>" +
      //htmlEscape(formatDate(date, colFormat)) +
      htmlEscape(resources[i].name) +
        "</th>";
    }
    html +=
  ...
  function buildDayTableBodyHTML() {
    ...
    cellsHTML = '';
    for (col = 0; col < resources.length; col++) {
      // how to do this?
